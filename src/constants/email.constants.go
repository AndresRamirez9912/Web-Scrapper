...
const VERIFICATION_TEMPLATE_ADDRESS = "./src/services/emails/templates/emailVerification.template.html"
const LOWER_PRICE_TEMPLATE_ADDRESS = "./src/services/emails/templates/templates/lowerPriceNotification.template.html"
