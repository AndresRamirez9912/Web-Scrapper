...
const VERIFICATION_TEMPLATE_ADDRESS = "./templates/emailVerification.template.html"
const LOWER_PRICE_TEMPLATE_ADDRESS = "./templates/lowerPriceNotification.template.html"
