...
func (j *JumboScraper) OnRequest(r *colly.Request) {
...
func (j *JumboScraper) OnResponse(r *colly.Response) {
	log.Println("Response Code: ", r.StatusCode)
}

func (j *JumboScraper) OnError(r *colly.Response, err error) {
	log.Println("Error making the scraping: ", err)
}

func (j *JumboScraper) OnHTML(h *colly.HTMLElement) {
	if j.Name == "" {
...
func (s JumboScraper) GetQuerySelector() string {
