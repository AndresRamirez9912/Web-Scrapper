...
func (a *AmazonProduct) OnRequest(r *colly.Request) {
...
func (a *AmazonProduct) OnResponse(r *colly.Response) {
	log.Println("Response Code: ", r.StatusCode)
}

func (a *AmazonProduct) OnError(r *colly.Response, err error) {
	log.Println("Error making the scraping: ", err)
}

func (a *AmazonProduct) OnHTML(h *colly.HTMLElement) {
...
// Owner Functions
func (a *AmazonProduct) getProductId(productURL string) error {
...
func (s AmazonProduct) GetQuerySelector() string {
	return constants.AMAZON_QUERY_SELECTOR
}

func (s *AmazonProduct) SetURL(URL string) {
	s.ProductURL = URL
}
